 ...
 *
 * v2.0.0: Updated command structure
 * - brainstorm/start.md, brainstorm/clarify.md, brainstorm/spec.md
 * - feedback/add.md, feedback/resolve.md
 * - spec/create.md, spec/decompose.md, spec/execute.md, spec/doc-update.md, spec/refine.md, spec/validate.md
 */
...
export async function doctor() {
  ...
  let claudeOk = false;
  let claudeVersion = 'not found (optional)';
  try {
    claudeVersion = execSync('claude --version', { encoding: 'utf8', stdio: 'pipe' }).trim();
    claudeOk = true;
  } catch (error) {
    // Not an error - Claude Code CLI is optional
  }
  printCheck('Claude Code CLI', claudeOk, claudeOk ? claudeVersion : 'not found (optional - other AI tools supported)');
